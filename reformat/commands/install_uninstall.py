...
from reformat.util import make_executable
from reformat.util import resource_text
...
def _install_hook_script(
    ...
    # If we have an existing hook, move it to reformat.legacy
    ...
    output.write_line(f'reformat installed at {hook_path}')
