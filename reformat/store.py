...
from reformat import file_lock
...
class Store:
    ...
    def __init__(self, directory: Optional[str] = None) -> None:
        ...
        if not os.path.exists(self.directory):
            ...
            with open(os.path.join(self.directory, 'README'), 'w') as f:
                f.write(
                    'This directory is maintained by the reformat project.\n'
                    'Learn more: https://github.com/reformat/reformat\n',
                )
    ...
    def exclusive_lock(self) -> Generator[None, None, None]:
        def blocked_cb() -> None:  # pragma: no cover (tests are in-process)
            logger.info('Locking reformat directory')
    ...
    LOCAL_RESOURCES = (
        ...
        'package.json', 'reformat_placeholder_package.gemspec', 'setup.py',
