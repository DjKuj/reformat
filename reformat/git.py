...
def no_git_env(
    ...
    # https://github.com/reformat/reformat/issues/300
    # In git 2.6.3 (maybe others), git exports GIT_WORK_TREE while running
    # reformat hooks
    # In git 1.9.1 (maybe others), git exports GIT_DIR and GIT_INDEX_FILE
    # while running reformat hooks in submodules.
...
def commit(repo: str = '.') -> None:
    env = no_git_env()
    name, email = 'reformat', 'asottile+reformat@umich.edu'
...
def check_for_cygwin_mismatch() -> None:
    """See https://github.com/reformat/reformat/issues/354"""
    if sys.platform in ('cygwin', 'win32'):  # pragma: no cover (windows)
        ...
        if is_cygwin_python ^ is_cygwin_git:
            ...
            logger.warn(
                f'reformat has detected a mix of cygwin python / git\n'
